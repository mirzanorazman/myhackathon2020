        ...
        >
          <div class="sm:text-center lg:text-left">
            ...
            >
              Selamat datang ke
              <br class="xl:hidden" />
              <span class="text-indigo-600">Portal MyOKU!</span>
            </h2>
            <p
              class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"
            >
              Portal rasmi perkhidmatan OKU dalam talian untuk rakyat Malaysia.
            </p>
            <div
