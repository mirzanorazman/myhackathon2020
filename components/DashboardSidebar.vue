<template>
  ...
  >
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1 text-gray-800">UTAMA</p>
      <nuxt-link
        to="/pengguna"
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
        :class="this.$route.path == '/pengguna' ? 'bg-gray-300' : ''"
      >
        ...
        <span class="text-gray-800">Mukadepan</span>
      </nuxt-link>
      <!-- <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
      >
        ...
        <span class="text-gray-800">Status permohonan</span>
      </div> -->
      <nuxt-link
        to="/pengguna/biodata"
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
        :class="this.$route.path == '/pengguna/biodata' ? 'bg-gray-300' : ''"
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
      ...
      >
        ...
        <span class="text-gray-800">Enquiries</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
      >
        ...
        <span class="text-gray-800">Calendar</span>
      </div> -->
    </div>

    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1 text-gray-800">PERMOHONAN</p>
      <nuxt-link
        to="/pengguna/status-permohonan"
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
        :class="
          this.$route.path == '/pengguna/status-permohonan' ? 'bg-gray-300' : ''
        "
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
      ...
      <nuxt-link
        to="/pengguna/tambah-doktor"
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
        :class="
          this.$route.path == '/pengguna/tambah-doktor' ? 'bg-gray-300' : ''
        "
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-800">Tambah doktor</span>
      </nuxt-link>
    </div>

    <!-- <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1 text-gray-800">MISC</p>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
        ...
        <span class="text-gray-800">Notices</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
      >
        ...
        <span class="text-gray-800">Controls</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-300 rounded-lg cursor-pointer"
      >
